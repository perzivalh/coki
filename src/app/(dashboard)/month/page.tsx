            ...
            {categories.length > 0 ? (
                <div className={styles.catSection}>
                    <div className={styles.sectionHeader}>
                        <h2 className={styles.sectionTitle}>Top Categorías</h2>
                    </div>
                            ...
                            <div key={cat.slug} className={styles.catItem}>
                                <div className={styles.catMeta}>
                                    ...
                                    <div>
                                        ...
                                        <p className={styles.catCount}>{cat.count} transacción{cat.count !== 1 ? "es" : ""}</p>
                                    </div>
                                </div>
                                <ProgressBar
                                    value={cat.pct}
                                    rightLabel={`Bs ${cat.total.toFixed(2)}`}
